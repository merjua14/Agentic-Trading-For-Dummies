...
5/ Every paper entry needs a real invalidation level, a stop that is actually resting, and a size that comes from that 1.5% risk. No level, no trade.

6/ Nothing here promises a return. Perps can wipe an account. This tutorial stays on paper so you can watch the loop before any of that is your money. Read DISCLAIMER.md.
